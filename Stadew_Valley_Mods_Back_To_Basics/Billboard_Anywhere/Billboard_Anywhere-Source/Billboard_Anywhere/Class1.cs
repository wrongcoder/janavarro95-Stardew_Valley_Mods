...
namespace Billboard_Anywhere
{
    public class Class1 : Mod
    {
        ...
        void DataLoader_Settings()
        {
            ...
            string mylocation = Path.Combine(PathOnDisk, "Billboard_Anywhere_Config");
        ...
        void MyWritter_Settings()
        {
            ...
            {
                Log.Info("Billboard_Anywhere: The Billboard Anywhere Config doesn't exist. Creating it now.");
