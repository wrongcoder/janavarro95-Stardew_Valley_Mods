...
namespace Revitalize.Framework.Objects
{
    public class ResourceManager
    {
        ...
        private void loadInOreItems()
        {
            ...
            CustomObject steelIngot = new CustomObject(new BasicItemInformation("Steel Ingot",Constants.ItemIds.Resources.Ingots.SteelIngot, "A steel ingot that was made by processing iron again with more coal. It can be used for crafting purposes especially for making new machines.", "Ore", Color.Silver, -300, -300, 0, false, 180, false, false, TextureManager.GetTexture(ModCore.Manifest, "Revitalize.Items.Resources.Ore", "SteelIngot"), new AnimationManager(), Color.White, true, new Vector2(1, 1), null, null), 1);
