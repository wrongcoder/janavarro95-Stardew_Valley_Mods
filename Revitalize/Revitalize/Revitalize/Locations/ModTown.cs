...
namespace Revitalize.Locations
{
    public class ModTown : GameLoc
    {
        ...
        public ModTown(Map map, string name) : base(map, name)
        {
        }
        ...
        public override bool checkAction(Location tileLocation, xTile.Dimensions.Rectangle viewport, Farmer who)
        {
            ...
            IL_677:
            Log.AsyncG("TileLocation" + tileLocation);
            Log.AsyncG("viewport"+viewport);
            Log.AsyncG("who"+who);
        ...
        public override void draw(SpriteBatch spriteBatch)
        {
            ...
            if (this.ccJoja)
            {
                spriteBatch.Draw(Game1.mouseCursors, Game1.GlobalToLocal(Game1.viewport, this.ccFacadePositionBottom), new Microsoft.Xna.Framework.Rectangle?(ModTown.jojaFacadeBottom), Color.White, 0f, Vector2.Zero, (float)Game1.pixelZoom, SpriteEffects.None, (float)(20 * Game1.tileSize) / 10000f);
            }
        ...
        public override void drawAboveAlwaysFrontLayer(SpriteBatch b)
        {
            if (this.ccJoja)
            {
                b.Draw(Game1.mouseCursors, Game1.GlobalToLocal(Game1.viewport, this.ccFacadePosition), new Microsoft.Xna.Framework.Rectangle?(ModTown.jojaFacadeTop), Color.White, 0f, Vector2.Zero, (float)Game1.pixelZoom, SpriteEffects.None, (float)(20 * Game1.tileSize) / 10000f);
                if (Game1.IsWinter)
                {
                    b.Draw(Game1.mouseCursors, Game1.GlobalToLocal(Game1.viewport, this.ccFacadePosition), new Microsoft.Xna.Framework.Rectangle?(ModTown.jojaFacadeWinterOverlay), Color.White, 0f, Vector2.Zero, (float)Game1.pixelZoom, SpriteEffects.None, (float)(20 * Game1.tileSize + 1) / 10000f);
                }
            }
            else if (this.ccRefurbished)
            {
                b.Draw(Game1.mouseCursors, Game1.GlobalToLocal(Game1.viewport, this.clockCenter), new Microsoft.Xna.Framework.Rectangle?(ModTown.hourHandSource), Color.White, (float)(6.2831853071795862 * (double)((float)(Game1.timeOfDay % 1200) / 1200f) + (double)((float)Game1.gameTimeInterval / 7000f / 23f)), new Vector2(2.5f, 8f), (float)Game1.pixelZoom, SpriteEffects.None, 0.98f);
                b.Draw(Game1.mouseCursors, Game1.GlobalToLocal(Game1.viewport, this.clockCenter), new Microsoft.Xna.Framework.Rectangle?(ModTown.minuteHandSource), Color.White, (float)(6.2831853071795862 * (double)((float)(Game1.timeOfDay % 1000 % 100 % 60) / 60f) + (double)((float)Game1.gameTimeInterval / 7000f * 1.02f)), new Vector2(2.5f, 12f), (float)Game1.pixelZoom, SpriteEffects.None, 0.99f);
                b.Draw(Game1.mouseCursors, Game1.GlobalToLocal(Game1.viewport, this.clockCenter), new Microsoft.Xna.Framework.Rectangle?(ModTown.clockNub), Color.White, 0f, new Vector2(2f, 2f), (float)Game1.pixelZoom, SpriteEffects.None, 1f);
            }
